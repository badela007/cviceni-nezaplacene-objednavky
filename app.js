...
const identifikatory = nezaplaceneObjednavky.map((idObjednavky) => {
  return idObjednavky.id;
});
const emaily = nezaplaceneObjednavky.map((emailyObjednavek) => {
  return emailyObjednavek.uzivatel.email;
});
